...
This is the result of one day of doing this. I purposefully have the envelopes very simple - there's just a single one. There also is no modulation (... this is the top priority, if I attempt to make this for a whole second day).

To build:
-*This is only tested on Fedora 43, running the VST in Reaper*
